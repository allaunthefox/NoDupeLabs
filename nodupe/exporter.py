...
def write_folder_meta(folder_path: Path, file_records: List[Dict[str, Any]], root_path: Path, pretty: bool = False, silent: bool = True):
    """
    ...
    cats = Counter([categorize_file(r["mime"], r["name"])["category"] for r in filtered_records])
    topics: List[str] = []

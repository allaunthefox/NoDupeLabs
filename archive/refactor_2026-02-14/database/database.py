...
class Database:
    ...
    def __init__(self, db_path: str, timeout: float = 30.0):
        ...
        self.schema = DatabaseSchema(self)  # type: ignore[arg-type]
        self.indexing = DatabaseIndexing(self)  # type: ignore[arg-type]
        self.query = DatabaseQuery(self)  # type: ignore[arg-type]
        self.batch = DatabaseBatch(self)  # type: ignore[arg-type]
        self.transaction = DatabaseTransaction(self)  # type: ignore[arg-type]
    ...
    def transaction(self):
        ...
        with self.transaction.begin():  # type: ignore[attr-defined]
            yield
...
class DatabaseLoggingStrategy:
    ...
    def log_operation(self, message: str, level: str = "INFO") -> None:
        ...
        self.db.logging.log(message, level)  # type: ignore[attr-defined]
...
class DatabaseSecurityStrategy:
    ...
    def validate_security(self) -> Dict[str, Any]:
        ...
        return self.db.security.validate_security()  # type: ignore[attr-defined]
...
class DatabaseCacheStrategy:
    ...
    def cache_data(self, key: str, data: Any) -> None:
        """Cache data."""
        self.db.cache.set(key, data)  # type: ignore[attr-defined]
...
class DatabaseLockingStrategy:
    ...
    def acquire_lock(self, lock_name: str) -> None:
        ...
        with self.db.locking.lock(lock_name):  # type: ignore[attr-defined]
            pass

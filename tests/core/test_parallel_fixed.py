"""
Fixed test suite for parallel processing functionality.
Tests parallel operations from nodupe.core.parallel with multiprocessing fixes.
"""
...
class TestParallel:
    ...
    def test_process_in_parallel_with_processes(self):
        ...
        items = [1, 2, 3, 4]
        results = Parallel.process_in_parallel(_multiply_by_two, items, workers=2, use_processes=True)
    ...
    def test_map_parallel_with_processes(self):
        ...
        items = [1, 2, 3]
        results = Parallel.map_parallel(_cube, items, workers=2, use_processes=True)
    ...
    def test_map_parallel_unordered_with_processes(self):
        ...
        items = [1, 2, 3, 4]
        results = list(Parallel.map_parallel_unordered(_double, items, workers=2, use_processes=True))
    ...
    def test_smart_map_cpu_bound(self):
        ...
        # Use a module-level function for multiprocessing compatibility
        items = [1, 2, 3]
        results = Parallel.smart_map(_multiply_by_two, items, task_type='cpu', workers=2)
    ...
    def test_smart_map_auto_detect(self):
        ...
        items = [1, 2, 3, 4]
        results = Parallel.smart_map(_simple_add, items, task_type='auto', workers=2)

...
class TestCLIArgumentParsing:
    ...
    def test_performance_overrides(self):
        ...
        with patch(
            "sys.argv",
            ["nodupe", "--cores", "4", "--max-workers", "8", "version"],
        ):
            result = main()
            assert result == 0
...
class TestCLIHelpSystem:
    ...
    def test_version_help(self):
        ...
        with (
            patch("sys.argv", ["nodupe", "version", "--help"]),
    ...
    def test_tool_help(self):
        ...
        with (
            patch("sys.argv", ["nodupe", "tool", "--help"]),
            pytest.raises(SystemExit),
        ):
            main()
    ...
    def test_debug_logging_enabled(self):
        ...
        with patch("sys.argv", ["nodupe", "--debug", "version"]):
            with patch("nodupe.core.main.logging.getLogger") as mock_logger:
                ...
                mock_logger.return_value.setLevel.assert_called_with(
                    logging.DEBUG
                )
